      ...
      <main className="bg-white">
        <section className="px-5 py-16 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.85fr_1fr]">
            <div>
              <SectionTitle eyebrow="Contato" title="Solicite um orçamento" description="Envie as informações iniciais do projeto para a Marinox avaliar o melhor caminho comercial." />
              ...
              <div className="mt-6 rounded-lg border border-dashed border-zinc-300 bg-zinc-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">CTA preparado para download ou visualização quando o arquivo oficial for fornecido.</p>
              </div>
            </div>
            <ContactForm />
          </div>
        ...
        <section className="border-t border-zinc-200 bg-zinc-50 px-5 py-12 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1fr_.8fr] md:items-center">
            <div className="relative aspect-[16/9] overflow-hidden rounded-lg bg-white">
              <Image src="/marinox-assets/assets-images-backgrounds-map.png" alt="Mapa provisório" fill sizes="(min-width: 768px) 55vw, 100vw" className="object-cover" />
            </div>
            <div>
              <MessageCircle className="mb-4 size-7 text-red-700" />
              <h2 className="text-3xl font-semibold text-zinc-950">WhatsApp configurável</h2>
              <p className="mt-4 leading-7 text-zinc-600">O número está centralizado em configuração para substituição posterior, junto com endereço e redes sociais definitivos.</p>
