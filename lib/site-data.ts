...
export const navItems = [
  { href: '/', label: 'Início' },
  { href: '/a-marinox', label: 'A Marinox' },
...
export const solutions = [
  {
    ...
    summary:
      'Execução de estruturas metálicas sob medida para projetos corporativos, comerciais e institucionais.',
    applications: [
      'Estruturas para obras e reformas',
      'Apoio a construtoras e empresas de engenharia',
      'Soluções sob demanda para projetos em metal',
    ],
    image: '/marinox-assets/assets-images-sliders-1.jpg',
  },
  {
    slug: 'esquadrias-de-ferro',
    title: 'Esquadrias de ferro',
    summary:
      'Soluções em ferro para portas, gradis, guarda-corpos e elementos que exigem resistência e acabamento.',
    applications: [
      'Portas e fechamentos',
      'Guarda-corpos e corrimãos',
      'Peças especiais para obras',
    ],
    image: '/marinox-assets/assets-images-portfolio-grid-porta.jpeg',
  },
  {
    slug: 'esquadrias-de-aluminio',
    title: 'Esquadrias de alumínio',
    summary:
      'Planejamento e execução de esquadrias de alumínio para necessidades comerciais e residenciais.',
    applications: [
      'Projetos de arquitetura',
      'Obras corporativas',
      'Soluções de fechamento e acabamento',
    ],
    image: '/marinox-assets/assets-images-sliders-2.jpg',
  },
  {
    slug: 'artefatos-metalicos',
    title: 'Artefatos metálicos',
    summary:
      'Fabricação de artefatos metálicos, mobiliários, cristaleiras e peças sob medida para diferentes usos.',
    applications: [
      'Mobiliário metálico',
      'Cristaleiras e peças especiais',
      'Elementos sob medida para ambientes comerciais',
    ],
    image: '/marinox-assets/assets-images-portfolio-grid-Cristaleira.jpeg',
  },
];
...
export const projects = [
  {
    ...
    gallery: [
      ...
      '/marinox-assets/assets-images-portfolio-grid-Cristaleira.jpeg',
    ],
    solution: 'Artefatos metálicos',
  },
  {
    ...
    gallery: [
      ...
      '/marinox-assets/assets-images-portfolio-grid-smart1.jpeg',
    ],
    solution: 'Esquadrias de ferro',
  },
  {
    ...
    gallery: [
      ...
      '/marinox-assets/assets-images-portfolio-grid-porta.jpeg',
      '/marinox-assets/assets-images-portfolio-grid-colegio1.jpeg',
    ],
    solution: 'Estruturas metálicas',
  },
];

export const articles = [
  {
    slug: 'como-preparar-um-orcamento-de-estrutura-metalica',
  ...
  {
    slug: 'execucao-de-projetos-metalicos-com-prazo-e-qualidade',
